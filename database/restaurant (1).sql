...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 18, 2019 lúc 02:16 AM
...
INSERT INTO `products` (`id`, `product_name`, `prices`, `description`, `category_id`, `status`) VALUES
(1, 'Rau muống xào tỏi', 35000, 'Đây là món rau muống xào tỏi', 2, 1);
...
(2, 'cung', 989710452, 'cungnguyen112b3@gmail.com', '$2y$10$t22AeFNLV6sbidAxrgrl6eRK06Y/PN6BFDPIuj5/P/fm.4m2ysjiS', 1);
